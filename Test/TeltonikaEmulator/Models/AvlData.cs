...
namespace TeltonikaEmulator.Models
{
    public class AvlData
    {
        ...
        public GpsElement GpsElement { get; set; }
        public IoElement IoElement { get; set; }
    ...
    public class IoElement
    {
        public IoElement()
        {
            OneBytesIoProperties = new List<IoProperty<byte>>();
            TwoBytesIoProperties = new List<IoProperty<ushort>>();
            FourBytesIoProperties = new List<IoProperty<uint>>();
            EightBytesIoProperties = new List<IoProperty<ulong>>();
        }
        public byte EventIoID { get; set; }
        public byte TotalNumberOfIoProperties => Convert.ToByte(OneBytesIoProperties.Count + TwoBytesIoProperties.Count + FourBytesIoProperties.Count + EightBytesIoProperties.Count);
        public List<IoProperty<byte>> OneBytesIoProperties { get; set; }
        public List<IoProperty<UInt16>> TwoBytesIoProperties { get; set; }
        public List<IoProperty<UInt32>> FourBytesIoProperties { get; set; }
        public List<IoProperty<UInt64>> EightBytesIoProperties { get; set; }
        public DateTime DataUtc { get; set; }

    }

    public class IoProperty<T>
    {
        public IoProperty(byte iD, T value)
        {
            ID = iD;
            Value = value;
        }
    ...
    public class GpsElement
    {
        ...
        public UInt16 Altitude { get; set; }
         public int SatsVisibles { get; set; }
