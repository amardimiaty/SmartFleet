...
public class ExpressionStarter<T>
{
    ...
    {
        return (Predicate == null ? null : Predicate.ToString()) ?? throw new InvalidOperationException();
    }
    ...
    {
        get { return Predicate.ReturnType; }
    }

    /// <summary></summary>
    public bool TailCall
    {
        get { return Predicate.TailCall; }
    }
#endif
    ...
    {
        get { return Predicate.CanReduce; }
    }
#endif
