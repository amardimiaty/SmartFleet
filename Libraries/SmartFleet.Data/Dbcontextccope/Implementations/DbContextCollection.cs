...
namespace SmartFleet.Data.Dbcontextccope.Implementations
{
    ...
    {
        private Dictionary<Type, IdentityDbContext<IdentityUser>> _initializedDbContexts;
        private Dictionary<IdentityDbContext<IdentityUser>, DbContextTransaction> _transactions; 
        ...
        internal Dictionary<Type, IdentityDbContext<IdentityUser>> InitializedDbContexts { get { return _initializedDbContexts; } }
        ...
        public DbContextCollection(bool readOnly = false, IsolationLevel? isolationLevel = null, IDbContextFactory dbContextFactory = null)
        {
            ...
            _initializedDbContexts = new Dictionary<Type, IdentityDbContext<IdentityUser>>();
            _transactions = new Dictionary<IdentityDbContext<IdentityUser>, DbContextTransaction>();
